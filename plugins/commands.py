...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
            ...
            InlineKeyboardButton('ᴜᴩᴅᴀᴛᴇꜱ', url='https://t.me/Tamilyogioffical'),
            InlineKeyboardButton('ꜱᴜᴩᴩᴏʀᴛ', url='https://t.me/Tamilyogioffical'),
        ],[
            InlineKeyboardButton('ꜱᴜᴩᴩᴏʀᴛ ᴍʏ ᴄʜᴀɴɴᴇʟꜱ', url='https://t.me/Tamilyogioffical')
        ]]
...
async def settings(client, message):
    ...
    if settings is not None:
        ...
        await message.reply_photo(
            photo=random.choice(PICS),
            caption=f"<b>cʜᴀɴɢᴇ Yᴏᴜʀ sᴇᴛᴛɪɴɢꜱ ғᴏʀ {title} ᴀs ᴜʀ ᴡɪsʜ ⚙\n\nᴩᴏᴡᴇʀᴇᴅ ʙʏ - <a href=https://t.me/Tamilyogioffical>Tamilyogi official</a></b>",
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML,
