...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>ʜᴇʏ ᴅᴜᴅᴇ🥰,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇ ʜᴇʀᴇ........\nAꜱᴋ ᴍᴏᴠɪᴇ ᴏɴ ᴏᴜʀ ɢʀᴏᴜᴘ\nᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ᴛᴏ ᴊᴏɪɴ👇</b>",reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/Tamilyogioffical")]]))
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Tamilyogi official', callback_data='supportchannel')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        #],[
            InlineKeyboardButton('ʀǫ-ɢʀᴏᴜᴘ', url="https://t.me/Tamilyogioffical"),
            InlineKeyboardButton('ᴄʜᴀɴɴᴇʟ', url="https://t.me/+LljZgInMPu1iN2Nl")
        ],[
            InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs', url="https://t.me/Tamilyogioffical"),
            InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url="https://t.me/Tamilyogioffical")
        ],[
            InlineKeyboardButton('⇇ ʙᴀᴄᴋ ᴛᴏ ʜᴏᴍᴇ ⇉', callback_data='start'),
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
